...
UNIF_BOARD_START()
	...
	UNIF_BOARD("NES-TEROM",						B_NINTENDO_TxROM)
	UNIF_BOARD("NES-TL1ROM",					B_NINTENDO_TxROM)
	...
	//AxROM
	UNIF_BOARD("NES-AMROM",						B_NINTENDO_AxROM)
	UNIF_BOARD("NES-ANROM",						B_NINTENDO_AxROM)
	UNIF_BOARD("NES-AN1ROM",					B_NINTENDO_AxROM)
	UNIF_BOARD("NES-AOROM",						B_NINTENDO_AxROM)
	UNIF_BOARD("ACCLAIM-AOROM",				B_NINTENDO_AxROM)

	//GNROM/MHROM
//	UNIF_BOARD("NES-GNROM",						B_NINTENDO_GxROM_MxROM)
//	UNIF_BOARD("NES-MHROM",						B_NINTENDO_GxROM_MxROM)
	...
	UNIF_BOARD("HVC-FKROM",						B_NINTENDO_FxROM)
