...
#define mem_unsetcpu1(p)		mem_unsetcpu(1,p)
#define mem_unsetcpu2(p)		mem_unsetcpu(2,p)
...
#define mem_setprg1(p,b)		mem_setprg(1,p,b)
#define mem_setprg2(p,b)		mem_setprg(2,p,b)
...
#define mem_setwram1(p,b)		mem_setwram(1,p,b)
#define mem_setwram2(p,b)		mem_setwram(2,p,b)
