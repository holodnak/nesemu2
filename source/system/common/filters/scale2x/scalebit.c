 ...
 * \param height Vertical size in pixels of the source bitmap.
 */
void scale3x(void* void_dst, unsigned dst_slice, const void* void_src, unsigned src_slice, unsigned width, unsigned height)
{
	unsigned char* dst = (unsigned char*)void_dst;
	const unsigned char* src = (const unsigned char*)void_src;
	unsigned count;
 ...
 * \param height Vertical size in pixels of the source bitmap.
 */
void scale4x(void* void_dst, unsigned dst_slice, const void* void_src, unsigned src_slice, unsigned width, unsigned height)
{
	unsigned mid_slice;
	void* mid;
	unsigned pixel = 4;
